...
The examples use [prapaa-ai/hello-agav](https://github.com/prapaa-ai/hello-agav), but the patterns apply to any repository.
...
| Install and set up a marketplace agent | [Install and Configure an Agent](/guides/install-and-configure-agent) |
