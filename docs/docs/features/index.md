...
- [Built-in tools](/features/built-in-tools) cover files, search, shell, testing, language servers, notebooks, GitHub, web access, plans, and memory.
- [Skills](/features/skills) package reusable instructions and tool policies.
- [MCP](/features/mcp) connects stdio servers that expose tools, resources, and prompts.
