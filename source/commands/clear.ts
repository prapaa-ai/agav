...
export const clearCommand: SlashCommand = {
  ...
  usage: "Usage: /clear\n\nClears the current conversation and starts fresh.\nYour previous session is auto-saved — use /history to reopen it.",
  async execute(_args: string, context: CommandContext): Promise<CommandResult> {
    context.clearMessages();
    return { type: "message", text: "Started a new chat. Your previous sessions are still saved; use /history to reopen one." };
  },
};
